...
BENCHMARKS = {
    ...
    "mandelbrot_gpu": {"folder": "mandelbrot_gpu", "stem": "mandelbrot_gpu", "default_size": 4096, "baseline": "noop_gpu", "verify": {"skip": "escape-time iteration counts at boundary pixels are sensitive to tiny floating-point differences between Mojo's TileTensor GPU codegen and raw CUDA C double arithmetic (observed at the default size=4096: 2816283 for C/Rust/Java/Python vs Mojo's 2816271, a 12-pixel disagreement out of 16777216) -- not a meaningful cross-language comparison"}},
    "matmul_gpu": {"folder": "matmul_gpu", "stem": "matmul_gpu", "default_size": 2048, "baseline": "noop_gpu"},
    "matmul_gpu_warm": {"folder": "matmul_gpu_warm", "stem": "matmul_gpu_warm", "default_size": 500, "baseline": "noop_gpu"},
